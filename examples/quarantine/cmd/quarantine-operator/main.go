...
import (
	...
	scheduler "github.com/solo-io/autopilot/examples/quarantine/pkg/scheduler"
...
func main() {
	...
	err = leader.Become(ctx, "quarantine-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	if err := aliases.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	// Setup Scheduler
	if err := scheduler.AddToManager(ctx, mgr, namespace); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
...
func serveCRMetrics(cfg *rest.Config) error {
	...
	filteredGVK, err := k8sutil.GetGVKsFromAddToScheme(v1.AddToScheme)
	if err != nil {
		return err
	}
